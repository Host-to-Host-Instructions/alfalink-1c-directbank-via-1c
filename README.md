...
- Список отзыва сертификатов **certificate_revocation_list.crl** Обновляется **каждый** месяц 13-го числа.
...
| Корсчет банка                       | 30101810200000000593                            |
| БИК банка                           | 044525593                                       |
| Номер зарплатного договора          | 00ATW5                                          |
| ФИО сотрудника                      | Семенов Семен Семенович                         |
| Отделение банка                     | 0000                                            |
| Лицевой счёт сотрудника             | 40817810604040000000                            |
